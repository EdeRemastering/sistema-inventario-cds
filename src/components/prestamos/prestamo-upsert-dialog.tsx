...
export function PrestamoUpsertDialog({
  serverAction,
  create = true,
  ubicaciones,
  defaultValues,
  ...
  const onSubmit = async (data: TicketFormData) => {
    try {
      ...
      await toast.promise(promise, {
        loading: create ? "Creando préstamo..." : "Actualizando préstamo...",
        success: create
  ...
  const title = create ? "Crear préstamo" : "Editar préstamo";
  ...
  return (
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto" data-tour="prestamo-form">
          <DialogHeader>
            <DialogTitle>{title}</DialogTitle>
          </DialogHeader>
          <form onSubmit={handleSubmit(onSubmit)} className="grid gap-4">
            {/* Número de préstamo - Solo mostrar al editar */}
            {!create && (
              <div className="grid gap-1">
                <Label htmlFor="numero_ticket">Número de préstamo</Label>
                <Input
                  id="numero_ticket"
                  type="text"
            ...
            {/* Fechas */}
            <div className="flex flex-col gap-4" data-tour="prestamo-form-fechas">
              <div data-tour="prestamo-form-fecha-inicio">

...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex min-w-0 flex-col gap-2 text-center sm:text-left pr-10",
        className
      )}
      {...props}
    />
...
function DialogFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex min-w-0 flex-col-reverse gap-2 sm:flex-row sm:justify-end [&>button]:w-full [&>button]:sm:w-auto",
        className
      )}
      {...props}
    />
